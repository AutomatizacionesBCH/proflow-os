...
const styles: Record<EmpresaStatus, string> = {
...
const dots: Record<EmpresaStatus, string> = {
  activo:    'bg-green-400',
...
type Props = { status: EmpresaStatus | null }

export function EmpresaStatusBadge({ status }: Props) {
